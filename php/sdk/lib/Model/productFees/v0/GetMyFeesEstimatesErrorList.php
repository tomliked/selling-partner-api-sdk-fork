 ...
 */
class GetMyFeesEstimatesErrorList implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors.
     *
     * @param array $errors a list of error responses returned when a request is unsuccessful
     */
