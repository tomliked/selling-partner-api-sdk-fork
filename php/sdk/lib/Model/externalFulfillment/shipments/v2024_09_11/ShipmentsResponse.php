 ...
 */
class ShipmentsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ShipmentsResponse';
    ...
    protected static array $openAPITypes = [
        'shipments' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Shipment[]',
        'pagination' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Pagination'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['shipments']) && (count($this->container['shipments']) < 0)) {
            $invalidProperties[] = "invalid value for 'shipments', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets shipments.
     *
     * @param null|array $shipments a list of shipments
     */
