...
class Dimension implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @return string[]
     */
    public function getDimensionUnitAllowableValues(): array
    {
        return [
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['dimension_unit']) {
            $invalidProperties[] = "'dimension_unit' can't be null";
        }
     ...
     * Sets dimension_unit.
     *
     * @param string $dimension_unit the unit of measurement of the dimension
     */
    public function setDimensionUnit(string $dimension_unit): self
    {
