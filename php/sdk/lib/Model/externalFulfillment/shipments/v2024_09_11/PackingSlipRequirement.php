 ...
 */
class PackingSlipRequirement implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'PackingSlipRequirement';
     ...
     * Sets requirement.
     *
     * @param null|string $requirement whether the packing slip is required to be attached to the shipment
     */
     ...
     * Sets status.
     *
     * @param null|string $status the status of the packing slip that is attached to the shipment
     */
