...
class ChargeBreakup implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'base_amount' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Amount',
        'discount_amount' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Amount',
        'net_amount' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Amount'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['discount_amount']) {
            $invalidProperties[] = "'discount_amount' can't be null";
        }
        if (null === $this->container['net_amount']) {
     ...
     * Sets base_amount.
     *
     * @param Amount $base_amount base_amount
     */
    public function setBaseAmount(Amount $base_amount): self
    {
     ...
     *
     * @param Amount $discount_amount discount_amount
     */
    public function setDiscountAmount(Amount $discount_amount): self
    {
     ...
     * Sets net_amount.
     *
     * @param Amount $net_amount net_amount
     */
    public function setNetAmount(Amount $net_amount): self
    {
