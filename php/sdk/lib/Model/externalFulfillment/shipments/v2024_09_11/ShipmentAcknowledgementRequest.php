...
/**
 * ShipmentAcknowledgementRequest Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class ShipmentAcknowledgementRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ShipmentAcknowledgementRequest';
    ...
    protected static array $openAPITypes = [
        'reference_id' => 'string',
        'line_items' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\LineItemWithReason[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (count($this->container['line_items']) < 0) {
            $invalidProperties[] = "invalid value for 'line_items', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets reference_id.
     *
     * @param null|string $reference_id a unique identifier for every shipment rejection
     */
     ...
     * Sets line_items.
     *
     * @param array $line_items details about the line items from the shipment that are being confirmed or rejected by the seller
     */
