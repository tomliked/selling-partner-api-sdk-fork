...
/**
 * LineItemWithReason Class Doc Comment.
 *
 * @category Class
 *
...
class LineItemWithReason implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'line_item' => '\SpApi\Model\externalFulfillment\shipments\v2024_09_11\LineItem',
        'reason' => 'string'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['line_item']) {
     ...
     * Sets line_item.
     *
     * @param LineItem $line_item line_item
     */
    public function setLineItem(LineItem $line_item): self
    {
     ...
     * Sets reason.
     *
     * @param null|string $reason the reason for the rejection of the line item
     */
