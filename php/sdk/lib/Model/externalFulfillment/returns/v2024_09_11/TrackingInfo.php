...
class TrackingInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets carrier_name.
     *
     * @param string $carrier_name the name of the third party courier service used to ship the return package
     */
     ...
     * Sets tracking_id.
     *
     * @param string $tracking_id the tracking ID of the return package
     */
