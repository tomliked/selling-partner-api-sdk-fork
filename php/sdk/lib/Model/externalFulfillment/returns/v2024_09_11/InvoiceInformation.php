...
/**
 * InvoiceInformation Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class InvoiceInformation implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'InvoiceInformation';
     ...
     * Sets id.
     *
     * @param string $id the unique ID of the invoice that corresponds to the return
     */
