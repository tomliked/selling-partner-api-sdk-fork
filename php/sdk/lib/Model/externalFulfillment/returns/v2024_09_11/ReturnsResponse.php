 ...
 */
class ReturnsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ReturnsResponse';
    ...
    protected static array $openAPITypes = [
        'returns' => '\SpApi\Model\externalFulfillment\returns\v2024_09_11\ModelReturn[]',
        'next_token' => 'string'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['returns']) && (count($this->container['returns']) < 0)) {
            $invalidProperties[] = "invalid value for 'returns', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets returns.
     *
     * @param null|array $returns a list of returns
     */
    public function setReturns(?array $returns): self
    {
        if (is_null($returns)) {
            array_push($this->openAPINullablesSetToNull, 'returns');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('returns', $nullablesSetToNull);
            if (false !== $index) {
