...
/**
 * BatchInventoryRequest Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class BatchInventoryRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'BatchInventoryRequest';
    ...
    protected static array $openAPITypes = [
        'requests' => '\SpApi\Model\externalFulfillment\inventory\v2024_09_11\InventoryRequest[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['requests']) && (count($this->container['requests']) > 10)) {
            $invalidProperties[] = "invalid value for 'requests', number of items must be less than or equal to 10.";
        }
     ...
     * Sets requests.
     *
     * @param null|array $requests a list of inventory requests
     */
