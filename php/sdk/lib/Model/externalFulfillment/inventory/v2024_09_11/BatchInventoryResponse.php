...
/**
 * BatchInventoryResponse Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class BatchInventoryResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'BatchInventoryResponse';
    ...
    protected static array $openAPITypes = [
        'responses' => '\SpApi\Model\externalFulfillment\inventory\v2024_09_11\InventoryResponse[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['responses']) && (count($this->container['responses']) > 25)) {
            $invalidProperties[] = "invalid value for 'responses', number of items must be less than or equal to 25.";
        }
     ...
     * Sets responses.
     *
     * @param null|array $responses a list of inventory request responses
     */
