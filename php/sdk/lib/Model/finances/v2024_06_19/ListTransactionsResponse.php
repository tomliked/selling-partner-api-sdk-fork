...
class ListTransactionsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\finances\v2024_06_19\TransactionsPayload'];
     ...
     * Gets payload.
     */
    public function getPayload(): ?TransactionsPayload
    {
     ...
     * Sets payload.
     *
     * @param null|TransactionsPayload $payload payload
     */
    public function setPayload(?TransactionsPayload $payload): self
    {
        if (is_null($payload)) {
