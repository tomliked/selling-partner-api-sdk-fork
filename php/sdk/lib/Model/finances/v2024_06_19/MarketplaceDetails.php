 ...
 */
class MarketplaceDetails implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $marketplace_name The name of the marketplace where the transaction occurred. For example: `Amazon.com`,`Amazon.in`
     */
