...
class RentalTransactionEvent implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rental_event_type', $data ?? [], null);
        $this->setIfExists('extension_length', $data ?? [], null);
        $this->setIfExists('posted_date', $data ?? [], null);
        $this->setIfExists('rental_charge_list', $data ?? [], null);
        $this->setIfExists('rental_fee_list', $data ?? [], null);
        $this->setIfExists('marketplace_name', $data ?? [], null);
        $this->setIfExists('rental_initial_value', $data ?? [], null);
        $this->setIfExists('rental_reimbursement', $data ?? [], null);
        $this->setIfExists('rental_tax_withheld_list', $data ?? [], null);
    }
