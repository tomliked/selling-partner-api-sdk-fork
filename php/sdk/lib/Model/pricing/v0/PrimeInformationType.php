...
class PrimeInformationType implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'PrimeInformationType';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_national_prime', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['is_prime']) {
            $invalidProperties[] = "'is_prime' can't be null";
        }
        if (null === $this->container['is_national_prime']) {
    ...
    {
        if (is_null($is_national_prime)) {
            throw new \InvalidArgumentException('non-nullable is_national_prime cannot be null');
        }
