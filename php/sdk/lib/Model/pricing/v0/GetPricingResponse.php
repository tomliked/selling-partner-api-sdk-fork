 ...
 */
class GetPricingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetPricingResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\pricing\v0\Price[]',
     ...
     * Sets payload.
     *
     * @param null|array $payload the payload for the `getPricing` and `getCompetitivePricing` operations
     */
