 ...
 */
class GetOffersResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetOffersResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\pricing\v0\GetOffersResult',
        'errors' => '\SpApi\Model\pricing\v0\Error[]'];
     ...
     * Sets payload.
     *
     * @param null|GetOffersResult $payload payload
     */
    public function setPayload(?GetOffersResult $payload): self
    {
        if (is_null($payload)) {
