 ...
 */
class PrimeDetails implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;

    public const ELIGIBILITY_NATIONAL = 'NATIONAL';
    public const ELIGIBILITY_REGIONAL = 'REGIONAL';
    public const ELIGIBILITY_NONE = 'NONE';

    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PrimeDetails';
     ...
     * @return string[]
     */
    public function getEligibilityAllowableValues(): array
    {
        return [
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['eligibility']) {
