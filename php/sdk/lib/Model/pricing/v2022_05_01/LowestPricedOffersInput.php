...
class LowestPricedOffersInput implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'LowestPricedOffersInput';
    ...
    protected static array $openAPITypes = [
        'item_condition' => '\SpApi\Model\pricing\v2022_05_01\Condition',
        'offer_type' => 'string'];
     ...
     * Sets offer_type.
     *
     * @param string $offer_type The input parameter specifies the type of offers requested for `LowestPricedOffers`. This applies to `Consumer` and `Business` offers. `Consumer` is the default `offerType`.
     */
