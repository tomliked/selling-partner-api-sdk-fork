...
class FulfillmentAvailability implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('fulfillment_channel_code', $data ?? [], null);
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['fulfillment_channel_code']) {
    ...
    {
        if (is_null($fulfillment_channel_code)) {
            throw new \InvalidArgumentException('non-nullable fulfillment_channel_code cannot be null');
        }
