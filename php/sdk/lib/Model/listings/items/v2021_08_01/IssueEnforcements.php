 ...
 */
class IssueEnforcements implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['exemption']) {
     ...
     * Sets actions.
     *
     * @param array $actions list of enforcement actions taken by Amazon that affect the publishing or status of a listing
     */
