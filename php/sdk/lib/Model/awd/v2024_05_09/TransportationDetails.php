...
class TransportationDetails implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'tracking_details' => '\SpApi\Model\awd\v2024_05_09\TrackingDetails[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['tracking_details']) {
            $invalidProperties[] = "'tracking_details' can't be null";
        }
     ...
     *
     * @param array $tracking_details Tracking details for the shipment. If using SPD transportation, this can be for each case. If not using SPD transportation, this is a single tracking entry for the entire shipment.
     */
    public function setTrackingDetails(array $tracking_details): self
    {
