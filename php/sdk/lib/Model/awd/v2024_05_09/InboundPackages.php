 ...
 */
class InboundPackages implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'InboundPackages';
    ...
    public function setPackagesToInbound(array $packages_to_inbound): self
    {
        ...
        if (count($packages_to_inbound) < 1) {
            throw new \InvalidArgumentException('invalid length for $packages_to_inbound when calling InboundPackages., number of items must be greater than or equal to 1.');
        }
