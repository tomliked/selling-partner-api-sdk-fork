 ...
 */
class RecordActionFeedbackRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;

    public const FEEDBACK_ACTION_CODE_SELLER_ACTION_COMPLETED = 'SELLER_ACTION_COMPLETED';
    ...
    {
        $this->setIfExists('feedback_action_code', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['feedback_action_code']) {
            $invalidProperties[] = "'feedback_action_code' can't be null";
        }
        $allowedValues = $this->getFeedbackActionCodeAllowableValues();
        if (!is_null($this->container['feedback_action_code']) && !in_array($this->container['feedback_action_code'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'feedback_action_code', must be one of '%s'",
                $this->container['feedback_action_code'],
