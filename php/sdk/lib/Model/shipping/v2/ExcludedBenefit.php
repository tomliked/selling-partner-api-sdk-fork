...
class ExcludedBenefit implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['benefit']) {
     ...
     * Sets reason_codes.
     *
     * @param null|array $reason_codes List of reasons (eg. LATE_DELIVERY_RISK, etc.) indicating why a benefit is excluded for a shipping offer.
     */
