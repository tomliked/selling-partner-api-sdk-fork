...
class Benefits implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['included_benefits']) {
            $invalidProperties[] = "'included_benefits' can't be null";
        }
        if (null === $this->container['excluded_benefits']) {
            $invalidProperties[] = "'excluded_benefits' can't be null";
        }
