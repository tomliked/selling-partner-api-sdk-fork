...
class CarrierAccount implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'CarrierAccount';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['carrier_account_id']) {
            $invalidProperties[] = "'carrier_account_id' can't be null";
        }
     ...
     *
     * @param string $carrier_account_id identifier for the seller's carrier account
     */
    public function setCarrierAccountId(string $carrier_account_id): self
    {
