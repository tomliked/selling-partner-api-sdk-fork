 ...
 */
class CancelShipmentResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets payload.
     *
     * @param null|array<string,object> $payload the payload for the cancelShipment operation
     */
