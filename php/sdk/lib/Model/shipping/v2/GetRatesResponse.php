...
class GetRatesResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetRatesResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\shipping\v2\GetRatesResult'];
     ...
     * Sets payload.
     *
     * @param null|GetRatesResult $payload payload
     */
    public function setPayload(?GetRatesResult $payload): self
    {
        if (is_null($payload)) {
