...
/**
 * ShipperInstruction Class Doc Comment.
 *
 * @category Class
 *
...
class ShipperInstruction implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ShipperInstruction';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['delivery_notes']) && (mb_strlen($this->container['delivery_notes']) > 256)) {
            $invalidProperties[] = "invalid value for 'delivery_notes', the character length must be smaller than or equal to 256.";
        }
     ...
     * Sets delivery_notes.
     *
     * @param null|string $delivery_notes The delivery notes for the shipment
     */
