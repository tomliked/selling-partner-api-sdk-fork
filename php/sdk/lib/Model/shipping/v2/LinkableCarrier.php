...
/**
 * LinkableCarrier Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class LinkableCarrier implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'carrier_id' => 'string',
        'linkable_account_types' => '\SpApi\Model\shipping\v2\LinkableAccountType[]'];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('linkable_account_types', $data ?? [], null);
    }
     ...
     *
     * @param null|array $linkable_account_types A list of LinkableAccountType
     */
