 ...
 */
class GetAdditionalInputsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetAdditionalInputsResponse';
     ...
     * Sets payload.
     *
     * @param null|array<string,object> $payload the JSON schema to use to provide additional inputs when required to purchase a shipping offering
     */
