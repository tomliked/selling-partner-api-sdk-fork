 ...
 */
class SupplySourceCapabilities implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'SupplySourceCapabilities';
     ...
     * Gets outbound.
     */
    public function getOutbound(): ?OutboundCapability
    {
     ...
     * Sets outbound.
     *
     * @param null|OutboundCapability $outbound outbound
     */
    public function setOutbound(?OutboundCapability $outbound): self
    {
        if (is_null($outbound)) {
     ...
     * Gets services.
     */
    public function getServices(): ?ServicesCapability
    {
     ...
     * Sets services.
     *
     * @param null|ServicesCapability $services services
     */
    public function setServices(?ServicesCapability $services): self
    {
        if (is_null($services)) {
