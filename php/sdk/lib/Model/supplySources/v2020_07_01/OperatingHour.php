 ...
 */
class OperatingHour implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OperatingHour';
     ...
     * Sets start_time.
     *
     * @param null|string $start_time the opening time, ISO 8601 formatted timestamp without date, HH:mm
     */
     ...
     * Sets end_time.
     *
     * @param null|string $end_time the closing time, ISO 8601 formatted timestamp without date, HH:mm
     */
