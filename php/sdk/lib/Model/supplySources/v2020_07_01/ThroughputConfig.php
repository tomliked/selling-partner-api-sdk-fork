 ...
 */
class ThroughputConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('throughput_cap', $data ?? [], null);
        $this->setIfExists('throughput_unit', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['throughput_unit']) {
