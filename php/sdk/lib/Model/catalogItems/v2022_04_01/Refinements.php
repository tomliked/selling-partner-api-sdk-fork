...
class Refinements implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['brands']) {
            $invalidProperties[] = "'brands' can't be null";
        }
        if (null === $this->container['classifications']) {
     ...
     * Sets brands.
     *
     * @param array $brands a list of brands you can use to refine your search
     */
     ...
     *
     * @param array $classifications a list of classifications you can use to refine your search
     */
