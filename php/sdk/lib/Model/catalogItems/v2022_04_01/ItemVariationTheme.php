...
class ItemVariationTheme implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets attributes.
     *
     * @param null|array $attributes names of the Amazon catalog item attributes that are associated with the variation theme
     */
     ...
     * Sets theme.
     *
     * @param null|string $theme variation theme that indicates the combination of Amazon catalog item attributes that define the variation family
     */
