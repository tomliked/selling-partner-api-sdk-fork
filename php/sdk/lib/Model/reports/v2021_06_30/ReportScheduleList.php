...
class ReportScheduleList implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'report_schedules' => '\SpApi\Model\reports\v2021_06_30\ReportSchedule[]'];
    ...
    {
        $this->setIfExists('report_schedules', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['report_schedules']) {
     ...
     *
     * @param array $report_schedules detailed information about a report schedule
     */
    public function setReportSchedules(array $report_schedules): self
    {
        if (is_null($report_schedules)) {
            throw new \InvalidArgumentException('non-nullable report_schedules cannot be null');
        }
