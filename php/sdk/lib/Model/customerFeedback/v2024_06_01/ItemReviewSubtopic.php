...
/**
 * ItemReviewSubtopic Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class ItemReviewSubtopic implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ItemReviewSubtopic';
    ...
    protected static array $openAPITypes = [
        'subtopic' => 'string',
        'metrics' => '\SpApi\Model\customerFeedback\v2024_06_01\ItemReviewSubtopicMetrics',
     ...
     * Gets metrics.
     */
    public function getMetrics(): ItemReviewSubtopicMetrics
    {
     ...
     * Sets metrics.
     *
     * @param ItemReviewSubtopicMetrics $metrics metrics
     */
    public function setMetrics(ItemReviewSubtopicMetrics $metrics): self
    {
        if (is_null($metrics)) {
     ...
     *
     * @param null|array $review_snippets A list of up to three snippets from reviews that contain the subtopic. This value is `null` if there aren't enough review snippets for the subtopic.
     */
    public function setReviewSnippets(?array $review_snippets): self
    {
        ...
        if (!is_null($review_snippets) && (count($review_snippets) > 3)) {
            throw new \InvalidArgumentException('invalid value for $review_snippets when calling ItemReviewSubtopic., number of items must be less than or equal to 3.');
        }
