...
class DateRange implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets start_date.
     *
     * @param \DateTime $start_date the start date of the date range in ISO-8601 date/time format
     */
     ...
     * Sets end_date.
     *
     * @param \DateTime $end_date the end date of the date range in ISO-8601 date/time format
     */
