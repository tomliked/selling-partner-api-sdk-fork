 ...
 */
class RangeCapacity implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('capacity_type', $data ?? [], null);
     ...
     * Sets capacity_type.
     *
     * @param null|string $capacity_type capacity_type
     */
    public function setCapacityType(?string $capacity_type): self
    {
        if (is_null($capacity_type)) {
            array_push($this->openAPINullablesSetToNull, 'capacity_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('capacity_type', $nullablesSetToNull);
            if (false !== $index) {
     ...
     * Sets slots.
     *
     * @param null|array $slots array of capacity slots in range slot format
     */
