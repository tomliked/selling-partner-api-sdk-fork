 ...
 */
class UpdateScheduleResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets payload.
     *
     * @param null|array $payload contains the `UpdateScheduleRecords` for which the error/warning has occurred
     */
