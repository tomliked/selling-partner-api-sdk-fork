 ...
 */
class UpdateScheduleRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'schedules' => '\SpApi\Model\services\v1\AvailabilityRecord[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['schedules']) {
     ...
     * Sets schedules.
     *
     * @param array $schedules list of `AvailabilityRecord`s to represent the capacity of a resource over a time range
     */
