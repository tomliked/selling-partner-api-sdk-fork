...
/**
 * UpdateReservationResponse Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class UpdateReservationResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\services\v1\UpdateReservationRecord',
     ...
     * Sets payload.
     *
     * @param null|UpdateReservationRecord $payload payload
     */
    public function setPayload(?UpdateReservationRecord $payload): self
    {
        if (is_null($payload)) {
