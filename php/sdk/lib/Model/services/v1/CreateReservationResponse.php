 ...
 */
class CreateReservationResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'CreateReservationResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\services\v1\CreateReservationRecord',
     ...
     * Sets payload.
     *
     * @param null|CreateReservationRecord $payload payload
     */
    public function setPayload(?CreateReservationRecord $payload): self
    {
        if (is_null($payload)) {
