 ...
 */
class GetAppointmentSlotsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetAppointmentSlotsResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\services\v1\AppointmentSlotReport',
     ...
     * Sets payload.
     *
     * @param null|AppointmentSlotReport $payload payload
     */
    public function setPayload(?AppointmentSlotReport $payload): self
    {
        if (is_null($payload)) {
