 ...
 */
class GetSolicitationActionsForOrderResponseLinks implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets actions.
     *
     * @param array $actions eligible actions for the specified amazonOrderId
     */
