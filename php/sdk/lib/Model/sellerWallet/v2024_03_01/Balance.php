...
class Balance implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'account_id' => 'string',
        'balance_type' => '\SpApi\Model\sellerWallet\v2024_03_01\BalanceType',
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['balance_amount']) {
            $invalidProperties[] = "'balance_amount' can't be null";
        }
        if (null === $this->container['balance_currency']) {
     ...
     * Sets balance_type.
     *
     * @param null|string $balance_type balance_type
     */
