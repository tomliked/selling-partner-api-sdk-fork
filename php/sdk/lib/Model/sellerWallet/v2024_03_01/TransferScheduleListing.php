 ...
 */
class TransferScheduleListing implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'TransferScheduleListing';
    ...
    protected static array $openAPITypes = [
        ...
        'transfer_schedules' => '\SpApi\Model\sellerWallet\v2024_03_01\TransferSchedule[]'];
    ...
    protected static array $setters = [
        ...
        'transfer_schedules' => 'setTransferSchedules',
    ];
    ...
    protected static array $getters = [
        ...
        'transfer_schedules' => 'getTransferSchedules',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transfer_schedules', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['transfer_schedules']) {
            $invalidProperties[] = "'transfer_schedules' can't be null";
        }
    ...
    /**
     * Gets transfer_schedules.
     */
    public function getTransferSchedules(): array
    {
        return $this->container['transfer_schedules'];
    }
    ...
    {
        if (is_null($transfer_schedules)) {
            throw new \InvalidArgumentException('non-nullable transfer_schedules cannot be null');
        }
        $this->container['transfer_schedules'] = $transfer_schedules;
