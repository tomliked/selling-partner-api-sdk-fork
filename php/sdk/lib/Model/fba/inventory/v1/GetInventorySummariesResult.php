...
class GetInventorySummariesResult implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('inventory_summaries', $data ?? [], null);
    }
     ...
     *
     * @param array $inventory_summaries a list of inventory summaries
     */
    public function setInventorySummaries(array $inventory_summaries): self
    {
        if (is_null($inventory_summaries)) {
            throw new \InvalidArgumentException('non-nullable inventory_summaries cannot be null');
        }
