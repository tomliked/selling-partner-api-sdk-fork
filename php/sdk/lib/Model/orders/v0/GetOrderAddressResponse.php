 ...
 */
class GetOrderAddressResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetOrderAddressResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\orders\v0\OrderAddress',
     ...
     * Gets payload.
     */
    public function getPayload(): ?OrderAddress
    {
     ...
     * Sets payload.
     *
     * @param null|OrderAddress $payload payload
     */
    public function setPayload(?OrderAddress $payload): self
    {
        if (is_null($payload)) {
