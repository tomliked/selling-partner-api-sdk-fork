...
class GetOrderItemsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetOrderItemsResponse';
     ...
     * Gets payload.
     */
    public function getPayload(): ?OrderItemsList
    {
     ...
     * Sets payload.
     *
     * @param null|OrderItemsList $payload payload
     */
    public function setPayload(?OrderItemsList $payload): self
    {
        if (is_null($payload)) {
