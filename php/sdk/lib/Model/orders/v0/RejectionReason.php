 ...
 */
class RejectionReason implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'RejectionReason';
    ...
    protected static array $openAPINullables = [
        ...
        'rejection_reason_description' => false,
    ];
    ...
    {
        $this->setIfExists('rejection_reason_id', $data ?? [], null);
        $this->setIfExists('rejection_reason_description', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['rejection_reason_id']) {
            $invalidProperties[] = "'rejection_reason_id' can't be null";
        }
        if (null === $this->container['rejection_reason_description']) {
