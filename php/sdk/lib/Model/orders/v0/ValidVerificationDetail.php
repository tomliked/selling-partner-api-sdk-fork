 ...
 */
class ValidVerificationDetail implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'verification_detail_type' => false,
        'valid_verification_statuses' => false,
    ];
    ...
    {
        $this->setIfExists('verification_detail_type', $data ?? [], null);
        $this->setIfExists('valid_verification_statuses', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['verification_detail_type']) {
            $invalidProperties[] = "'verification_detail_type' can't be null";
        }
        if (null === $this->container['valid_verification_statuses']) {
            $invalidProperties[] = "'valid_verification_statuses' can't be null";
        }
