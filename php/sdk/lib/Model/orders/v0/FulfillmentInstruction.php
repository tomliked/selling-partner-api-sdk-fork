...
class FulfillmentInstruction implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'FulfillmentInstruction';
    ...
    {
        $this->setIfExists('fulfillment_supply_source_id', $data ?? [], null);
    }
     ...
     *
     * @param null|string $fulfillment_supply_source_id the `sourceId` of the location from where you want the order fulfilled
     */
