...
class GetOrderRegulatedInfoResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetOrderRegulatedInfoResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\orders\v0\OrderRegulatedInfo',
     ...
     * Sets payload.
     *
     * @param null|OrderRegulatedInfo $payload payload
     */
    public function setPayload(?OrderRegulatedInfo $payload): self
    {
        if (is_null($payload)) {
