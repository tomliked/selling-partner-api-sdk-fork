 ...
 */
class GetOrdersResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetOrdersResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\orders\v0\OrdersList',
     ...
     * Gets payload.
     */
    public function getPayload(): ?OrdersList
    {
     ...
     * Sets payload.
     *
     * @param null|OrdersList $payload payload
     */
    public function setPayload(?OrdersList $payload): self
    {
        if (is_null($payload)) {
