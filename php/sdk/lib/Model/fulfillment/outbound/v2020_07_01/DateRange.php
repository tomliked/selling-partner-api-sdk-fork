...
class DateRange implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('earliest', $data ?? [], null);
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['earliest']) {
     ...
     */
    public function setEarliest(\DateTime $earliest): self
    {
        if (is_null($earliest)) {
            throw new \InvalidArgumentException('non-nullable earliest cannot be null');
        }
     ...
     */
    public function setLatest(\DateTime $latest): self
    {
        if (is_null($latest)) {
