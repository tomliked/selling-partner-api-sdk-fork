...
class ScheduledDeliveryInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('delivery_time_zone', $data ?? [], null);
        $this->setIfExists('delivery_windows', $data ?? [], null);
    }
    ...
    {
        if (is_null($delivery_time_zone)) {
            throw new \InvalidArgumentException('non-nullable delivery_time_zone cannot be null');
        }
     ...
     *
     * @param array $delivery_windows an array of delivery windows
     */
    public function setDeliveryWindows(array $delivery_windows): self
    {
        if (is_null($delivery_windows)) {
            throw new \InvalidArgumentException('non-nullable delivery_windows cannot be null');
        }
