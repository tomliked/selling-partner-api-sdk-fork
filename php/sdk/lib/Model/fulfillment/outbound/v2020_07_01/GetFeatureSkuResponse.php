 ...
 */
class GetFeatureSkuResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetFeatureSkuResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\outbound\v2020_07_01\GetFeatureSkuResult',
     ...
     * Sets payload.
     *
     * @param null|GetFeatureSkuResult $payload payload
     */
    public function setPayload(?GetFeatureSkuResult $payload): self
    {
        if (is_null($payload)) {
