 ...
 */
class GetPackageTrackingDetailsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetPackageTrackingDetailsResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\outbound\v2020_07_01\PackageTrackingDetails',
     ...
     * Sets payload.
     *
     * @param null|PackageTrackingDetails $payload payload
     */
    public function setPayload(?PackageTrackingDetails $payload): self
    {
        if (is_null($payload)) {
