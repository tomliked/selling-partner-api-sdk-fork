...
/**
 * LockerDetails Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class LockerDetails implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'LockerDetails';
    ...
    {
        $this->setIfExists('locker_number', $data ?? [], null);
        $this->setIfExists('locker_access_code', $data ?? [], null);
    }
     ...
     * Sets locker_number.
     *
     * @param null|string $locker_number Indicates the locker number
     */
    ...
    /**
     * Gets locker_access_code.
     */
    public function getLockerAccessCode(): ?string
    {
        return $this->container['locker_access_code'];
    }

    /**
     * Sets locker_access_code.
     *
     * @param null|string $locker_access_code Indicates the locker access code
     */
