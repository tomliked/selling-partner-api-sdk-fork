 ...
 */
class GetFulfillmentOrderResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetFulfillmentOrderResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\outbound\v2020_07_01\GetFulfillmentOrderResult',
     ...
     * Sets payload.
     *
     * @param null|GetFulfillmentOrderResult $payload payload
     */
    public function setPayload(?GetFulfillmentOrderResult $payload): self
    {
        if (is_null($payload)) {
