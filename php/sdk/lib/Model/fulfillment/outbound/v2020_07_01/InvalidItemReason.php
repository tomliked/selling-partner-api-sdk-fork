 ...
 */
class InvalidItemReason implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'invalid_item_reason_code' => false,
        'description' => false,
    ];
    ...
    {
        $this->setIfExists('invalid_item_reason_code', $data ?? [], null);
     ...
     */
    public function getInvalidItemReasonCode(): string
    {
     ...
     *
     * @param string $invalid_item_reason_code invalid_item_reason_code
     */
    public function setInvalidItemReasonCode(string $invalid_item_reason_code): self
    {
        if (is_null($invalid_item_reason_code)) {
            throw new \InvalidArgumentException('non-nullable invalid_item_reason_code cannot be null');
        }
