 ...
 */
class ListReturnReasonCodesResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\outbound\v2020_07_01\ListReturnReasonCodesResult',
     ...
     * Sets payload.
     *
     * @param null|ListReturnReasonCodesResult $payload payload
     */
    public function setPayload(?ListReturnReasonCodesResult $payload): self
    {
        if (is_null($payload)) {
