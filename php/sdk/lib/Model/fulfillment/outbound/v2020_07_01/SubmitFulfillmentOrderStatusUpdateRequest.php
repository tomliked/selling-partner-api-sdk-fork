 ...
 */
class SubmitFulfillmentOrderStatusUpdateRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $fulfillment_order_status fulfillment_order_status
     */
