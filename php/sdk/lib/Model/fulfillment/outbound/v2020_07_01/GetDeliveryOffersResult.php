 ...
 */
class GetDeliveryOffersResult implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetDeliveryOffersResult';
    ...
    protected static array $setters = [
        'delivery_offers' => 'setDeliveryOffers',
    ];
    ...
    protected static array $getters = [
        'delivery_offers' => 'getDeliveryOffers',
    ];
    ...
    {
        $this->setIfExists('delivery_offers', $data ?? [], null);
    }
    ...
    {
        return $this->container['delivery_offers'];
    }

    /**
     * Sets delivery_offers.
     *
     * @param null|array $delivery_offers an array of delivery offer information
     */
