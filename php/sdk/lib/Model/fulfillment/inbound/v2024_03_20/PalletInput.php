...
class PalletInput implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setQuantity(int $quantity): self
    {
        ...
        if ($quantity > 10000) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling PalletInput., must be smaller than or equal to 10000.');
        }
        if ($quantity < 1) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling PalletInput., must be bigger than or equal to 1.');
        }
