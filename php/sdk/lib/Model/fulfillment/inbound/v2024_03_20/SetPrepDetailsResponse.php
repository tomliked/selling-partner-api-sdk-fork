...
/**
 * SetPrepDetailsResponse Class Doc Comment.
 *
 * @category Class
 *
...
class SetPrepDetailsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setOperationId(string $operation_id): self
    {
        ...
        if (mb_strlen($operation_id) > 38) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling SetPrepDetailsResponse., must be smaller than or equal to 38.');
        }
        if (mb_strlen($operation_id) < 36) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling SetPrepDetailsResponse., must be bigger than or equal to 36.');
        }
        if (!preg_match('/^[a-zA-Z0-9-]*$/', ObjectSerializer::toString($operation_id))) {
            throw new \InvalidArgumentException('invalid value for $operation_id when calling SetPrepDetailsResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.');
        }
