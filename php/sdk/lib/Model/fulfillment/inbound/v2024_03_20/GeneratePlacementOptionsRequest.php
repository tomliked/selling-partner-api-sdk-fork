 ...
 */
class GeneratePlacementOptionsRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GeneratePlacementOptionsRequest';
    ...
    {
        $this->setIfExists('custom_placement', $data ?? [], null);
    }
     ...
     *
     * @param null|array $custom_placement Custom placement options you want to add to the plan. This is only used for the India (IN - A21TJRUUN4KGV) marketplace.
     */
