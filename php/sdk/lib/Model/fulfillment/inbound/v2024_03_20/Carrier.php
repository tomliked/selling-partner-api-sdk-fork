...
class Carrier implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('alpha_code', $data ?? [], null);
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['alpha_code']) && (mb_strlen($this->container['alpha_code']) > 1024)) {
            $invalidProperties[] = "invalid value for 'alpha_code', the character length must be smaller than or equal to 1024.";
        }

        if (!is_null($this->container['alpha_code']) && (mb_strlen($this->container['alpha_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'alpha_code', the character length must be bigger than or equal to 1.";
        }
