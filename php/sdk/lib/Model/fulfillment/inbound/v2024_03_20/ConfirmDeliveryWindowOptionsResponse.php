...
/**
 * ConfirmDeliveryWindowOptionsResponse Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class ConfirmDeliveryWindowOptionsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ConfirmDeliveryWindowOptionsResponse';
    ...
    public function setOperationId(string $operation_id): self
    {
        ...
        if (mb_strlen($operation_id) > 38) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling ConfirmDeliveryWindowOptionsResponse., must be smaller than or equal to 38.');
        }
        if (mb_strlen($operation_id) < 36) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling ConfirmDeliveryWindowOptionsResponse., must be bigger than or equal to 36.');
        }
        if (!preg_match('/^[a-zA-Z0-9-]*$/', ObjectSerializer::toString($operation_id))) {
            throw new \InvalidArgumentException('invalid value for $operation_id when calling ConfirmDeliveryWindowOptionsResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.');
        }
