 ...
 */
class GetLabelsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetLabelsResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\inbound\v0\LabelDownloadURL',
     ...
     * Sets payload.
     *
     * @param null|LabelDownloadURL $payload payload
     */
    public function setPayload(?LabelDownloadURL $payload): self
    {
        if (is_null($payload)) {
