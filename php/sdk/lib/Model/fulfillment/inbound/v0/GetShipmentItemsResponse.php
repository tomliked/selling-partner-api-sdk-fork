...
class GetShipmentItemsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetShipmentItemsResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\inbound\v0\GetShipmentItemsResult',
     ...
     * Sets payload.
     *
     * @param null|GetShipmentItemsResult $payload payload
     */
    public function setPayload(?GetShipmentItemsResult $payload): self
    {
        if (is_null($payload)) {
