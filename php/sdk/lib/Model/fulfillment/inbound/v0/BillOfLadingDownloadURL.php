 ...
 */
class BillOfLadingDownloadURL implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'BillOfLadingDownloadURL';
     ...
     * Sets download_url.
     *
     * @param null|string $download_url URL to download the bill of lading for the package. Note: The URL will only be valid for 15 seconds
     */
