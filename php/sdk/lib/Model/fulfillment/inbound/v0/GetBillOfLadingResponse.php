 ...
 */
class GetBillOfLadingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetBillOfLadingResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\inbound\v0\BillOfLadingDownloadURL',
     ...
     * Sets payload.
     *
     * @param null|BillOfLadingDownloadURL $payload payload
     */
    public function setPayload(?BillOfLadingDownloadURL $payload): self
    {
        if (is_null($payload)) {
