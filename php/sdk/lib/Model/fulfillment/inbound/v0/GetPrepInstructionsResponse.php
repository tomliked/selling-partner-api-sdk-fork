 ...
 */
class GetPrepInstructionsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetPrepInstructionsResponse';
    ...
    protected static array $openAPITypes = [
        'payload' => '\SpApi\Model\fulfillment\inbound\v0\GetPrepInstructionsResult',
     ...
     * Sets payload.
     *
     * @param null|GetPrepInstructionsResult $payload payload
     */
    public function setPayload(?GetPrepInstructionsResult $payload): self
    {
        if (is_null($payload)) {
