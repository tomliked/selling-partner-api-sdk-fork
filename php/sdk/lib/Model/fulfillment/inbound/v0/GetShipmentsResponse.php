 ...
 */
class GetShipmentsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetShipmentsResponse';
     ...
     * Gets payload.
     */
    public function getPayload(): ?GetShipmentsResult
    {
     ...
     * Sets payload.
     *
     * @param null|GetShipmentsResult $payload payload
     */
    public function setPayload(?GetShipmentsResult $payload): self
    {
        if (is_null($payload)) {
