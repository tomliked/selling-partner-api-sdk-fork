...
class Benefits implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'excluded_benefits' => '\SpApi\Model\merchantFulfillment\v0\ExcludedBenefit[]'];
    ...
    {
        $this->setIfExists('included_benefits', $data ?? [], null);
        $this->setIfExists('excluded_benefits', $data ?? [], null);
    }
     ...
     *
     * @param null|array $included_benefits a list of included benefits
     */
     ...
     *
     * @param null|array $excluded_benefits A list of excluded benefits. Refer to the `ExcludeBenefit` object for further documentation.
     */
