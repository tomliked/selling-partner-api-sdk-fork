...
class Constraint implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('validation_reg_ex', $data ?? [], null);
        $this->setIfExists('validation_string', $data ?? [], null);
    }
    ...
    {
        if (is_null($validation_string)) {
            throw new \InvalidArgumentException('non-nullable validation_string cannot be null');
        }
